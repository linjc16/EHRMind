...
def calculate_answer_score(json_str, target):
    ...
    try:
        ...
        if prediction == label_to_text[target] and idx == target:
            answer_score = 1
        else:
            answer_score = 0
...
def compute_score(solution_str, ground_truth, data_source, format_reward=0.1):
    ...
    if format_correct and answer_text:
        answer_score = calculate_answer_score(answer_text, target)
