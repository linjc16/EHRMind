...
from src.utils.deepseek import deepseek_r1



if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--model_name', type=str, default='deepseek-r1-3')
    ...
    for idx, prompt in enumerate(tqdm(inputs)):
        ...
        try:
            if args.model_name == 'deepseek-r1' or args.model_name == 'deepseek-r1-2' or args.model_name == 'deepseek-r1-3':
                decoded = deepseek_r1(prompt)
